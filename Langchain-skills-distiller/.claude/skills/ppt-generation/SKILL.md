...
- You don't need to check the folder under `D://workspace/skills-agent-proto-main/docs/`

### Step 2: Create Presentation Plan

Create a JSON file in `D://workspace/skills-agent-proto-main/docs/` with the presentation structure. **Important**: Include the `style` field to define the overall visual consistency.
...
```bash
python D:/workspace/skills-agent-proto-main/.claude/skills/scripts/generate.py \
  --prompt-file D://workspace/skills-agent-proto-main/docs/slide-01-prompt.json \
  --output-file D://workspace/skills-agent-proto-main/docs//slide-01.jpg \
  --aspect-ratio 16:9
```
...
```bash
python D:/workspace/skills-agent-proto-main/.claude/skills/scripts/generate.py \
  --prompt-file D://workspace/skills-agent-proto-main/docs/slide-02-prompt.json \
  --reference-images D://workspace/skills-agent-proto-main/docs//slide-01.jpg \
  --output-file D://workspace/skills-agent-proto-main/docs/slide-02.jpg \
  --aspect-ratio 16:9
```
...
python D:/workspace/skills-agent-proto-main/.claude/skills/scripts/generate.py \
  --prompt-file D://workspace/skills-agent-proto-main/docs/slide-03-prompt.json \
  --reference-images D://workspace/skills-agent-proto-main/docs/slide-02.jpg \
  --output-file D://workspace/skills-agent-proto-main/docs/slide-03.jpg \
  --aspect-ratio 16:9

# Slide 4 references slide 3
python D:/workspace/skills-agent-proto-main/.claude/skills/scripts/generate.py \
  --prompt-file D://workspace/skills-agent-proto-main/docs/slide-04-prompt.json \
  --reference-images D://workspace/skills-agent-proto-main/docs/slide-03.jpg \
  --output-file D://workspace/skills-agent-proto-main/docs/slide-04.jpg \
  --aspect-ratio 16:9
```
...
```bash
python D:/workspace/skills-agent-proto-main/.claude/skills/ppt-generation/scripts/generate.py \
  --plan-file D://workspace/skills-agent-proto-main/docs/presentation-plan.json \
  --slide-images D://workspace/skills-agent-proto-main/docs/slide-01.jpg D://workspace/skills-agent-proto-main/docs/slide-02.jpg D://workspace/skills-agent-proto-main/docs/slide-03.jpg \
  --output-file D://workspace/skills-agent-proto-main/docs/presentation.pptx
```
...
Create `D://workspace/skills-agent-proto-main/docs/ai-product-plan.json`:
```json
{
...
Read `D:/workspace/skills-agent-proto-main/.claude/skills/SKILL.md` to understand how to generate images.

### Step 3: Generate slide images sequentially with reference chaining

**Slide 1 - Title (establishes the visual language):**

Create `D://workspace/skills-agent-proto-main/docs/nova-slide-01.json`:
```json
{
...
```bash
python D:/workspace/skills-agent-proto-main/.claude/skills/scripts/generate.py \
  --prompt-file D://workspace/skills-agent-proto-main/docs/nova-slide-01.json \
  --output-file D://workspace/skills-agent-proto-main/docs/nova-slide-01.jpg \
  --aspect-ratio 16:9
```

**Slide 2 - Content (MUST reference slide 1 for consistency):**

Create `D://workspace/skills-agent-proto-main/docs/nova-slide-02.json`:
```json
{
...
```bash
python D:/workspace/skills-agent-proto-main/.claude/skills/scripts/generate.py \
  --prompt-file D://workspace/skills-agent-proto-main/docs/nova-slide-02.json \
  --reference-images D://workspace/skills-agent-proto-main/docs/nova-slide-01.jpg \
  --output-file D://workspace/skills-agent-proto-main/docs/nova-slide-02.jpg \
  --aspect-ratio 16:9
```
...
python /mnt/skills/public/ppt-generation/scripts/generate.py \
  --plan-file D://workspace/skills-agent-proto-main/docs/nova-plan.json \
  --slide-images D://workspace/skills-agent-proto-main/docs/nova-slide-01.jpg D://workspace/skills-agent-proto-main/docs/nova-slide-02.jpg D://workspace/skills-agent-proto-main/docs/nova-slide-03.jpg D://workspace/skills-agent-proto-main/docs/nova-slide-04.jpg D://workspace/skills-agent-proto-main/docs/nova-slide-05.jpg \
  --output-file D://workspace/skills-agent-proto-main/docs/nova-presentation.pptx
```
...
- The PPTX file is saved in `D://workspace/skills-agent-proto-main/docs/`
